...
WEB ACCESSIBILITY
is supervised by the web accessibility ininitiave and to help the people with disability to use ur website it is recommended to use the semantic html and allow access to assistive technology to navigate ur device without any problem.
...
CSS BASICS
is a language that is used to decorate and arrange content of the web page.
In order to affect content you first need to select them and manipulate them on the css

5 things that a developer needs to understand before coding CSS are 

Declaration block: a pair of curly braces
Declaration: is a key value pair of properties separated from their values with a colon
selector: indicate an element or elements u want to style, you can select by using an element name, identity, class, you can select based on the attributes too
...
To link to the css we use the link tag with href and rel and type
rel tells how the css file relate tot he html file
